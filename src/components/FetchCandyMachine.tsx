...
export const FetchCandyMachine: FC = () => {
  const [candyMachineAddress, setCandyMachineAddress] = useState("GNfbQEfMA1u1irEFnThTcrzDyefJsoa7sndACShaS5vC")
  ...
  const fetchCandyMachine = async () => {
    ...
    //set page to 1- we wanna be at the first page whenever we fetch a new candy mahchine
    setPage(1)
...
//next page
  ...
  //fetch metadat for NFTs when page or candy machine changes 
  useEffect(()=>{
    if (!candyMachineData){
      return 
    }
